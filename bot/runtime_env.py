...
LOCAL_ENV_KEYS = frozenset({
    ...
    # Isolated native BTC spot research / testnet-only execution controls.
    "BTC_SPOT_SHADOW_ENABLED", "BTC_SPOT_TESTNET_EXECUTION_ENABLED",
    "BTC_SPOT_MAX_ORDER_NOTIONAL_USDC", "BTC_SPOT_MAX_POSITION_NOTIONAL_USDC",
